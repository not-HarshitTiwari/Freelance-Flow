  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b px-6 py-4 flex items-center gap-3">
        ...
        <span className="text-gray-500 text-sm">Proposal Review</span>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        {!loading && proposal && !done && (
          <>
            ...
            <div className="bg-white rounded-2xl border p-6 mb-6 whitespace-pre-wrap text-sm text-gray-700 leading-relaxed">
              {proposal.content}
            </div>
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            {done === "accepted" ? (
              ...
              <>
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Proposal Rejected</h2>
